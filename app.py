...
full_options_list = [
    ...
    """ 👍 Rev only @ interval not @ Rectangle👍 Before 3pm, ATR&ADX > T, Outside CPR, ORB, Rectangle entry👍 Strend&EMA20 Broken👍 No pre BO & OBS (TL/IL)👍 Ccandle closed & <40 BO Ilevel👍 Max 1,2 Tcandle before Ccandle """
]
